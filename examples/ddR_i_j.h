...
Matrix3d ddR_0_0(const Vector3d & v) {
    Matrix3d ddR_0_0;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_0_1(const Vector3d & v) {
    Matrix3d ddR_0_1;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_0_2(const Vector3d & v) {
    Matrix3d ddR_0_2;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_1_0(const Vector3d & v) {
    Matrix3d ddR_1_0;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_1_1(const Vector3d & v) {
    Matrix3d ddR_1_1;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_1_2(const Vector3d & v) {
    Matrix3d ddR_1_2;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_2_0(const Vector3d & v) {
    Matrix3d ddR_2_0;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_2_1(const Vector3d & v) {
    Matrix3d ddR_2_1;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_2_2(const Vector3d & v) {
    Matrix3d ddR_2_2;
    double v0 = v[0];
    double v1 = v[1];
    double v2 = v[2];
...
Matrix3d ddR_i_j(const Vector3d &v, int i, int j) {
    assert(i >= 0 && i < 3);
    assert(j >= 0 && j < 3);

    if(i == 0 && j == 0) return ddR_0_0(v);
    if(i == 0 && j == 1) return ddR_0_1(v);
    if(i == 0 && j == 2) return ddR_0_2(v);
    if(i == 1 && j == 0) return ddR_1_0(v);
    if(i == 1 && j == 1) return ddR_1_1(v);
    if(i == 1 && j == 2) return ddR_1_2(v);
    if(i == 2 && j == 0) return ddR_2_0(v);
    if(i == 2 && j == 1) return ddR_2_1(v);
    if(i == 2 && j == 2) return ddR_2_2(v);

    throw std::runtime_error("ddR_i_j: i and j must be in [0,2]");
}
